...
@section('title', 'Alur Proses | Edit Alur Proses | Administrator')
...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        ...
        <h6 class="font-weight-bolder text-white mb-0"><i class="fa fa-refresh me-2"></i>Edit Alur Proses</h6>
    </nav>
@endsection
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-6 d-flex align-items-center">
                                <h6 class="mb-0 font-weight-bolder">Edit Alur Proses</h6>
                            </div>
                            ...
                            <div class="card px-0">
                                <div class="card-header pb-0 px-3">
                                    <div class="d-flex align-items-center">
                                        <p class="mb-0"><i class="fa fa-edit me-2"></i>Edit Data Alur Proses</p>
                                    </div>
                                </div>
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input class="form-control @error('name') is-invalid @enderror" value="{{ $flow->name }}" name="name" type="text" placeholder="Nama Alur Proses">
