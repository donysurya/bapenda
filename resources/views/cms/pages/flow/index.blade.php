    ...
    <div class="card-header pt-3">
        <div class="row mb-0 align-items-center">
            <div class="col-6 d-flex align-items-center">
                <h6 class="mb-0 font-weight-bolder"><i class="fa fa-refresh me-2"></i>Alur Proses</h6>
            </div>
            <div class="col-6 text-end">
                <a class="btn bg-gradient-dark mb-0" href="{{ route('cms.other.flow.create') }}"><i class="fas fa-plus"></i>&nbsp;&nbsp;Tambah</a>
            </div>
        </div>
    </div>
                        ...
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-uppercase text-secondary text-xs font-weight-bolder">Nama Alur Proses</th>
                                    <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder">Gambar Alur Proses</th>
                                ...
                                @forelse($flow as $index => $item)
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            ...
                                            <a href="{{ route('cms.other.flow.image', ['id' => $item->id]) }}" class="btn btn-success m-1 py-1 px-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Update Gambar Alur Proses" style="font-size:10px;">
                                        ...
                                        <td class="align-middle text-center">
                                            <a class="btn btn-link text-dark px-2 mb-0" href="{{ route('cms.other.flow.edit', ['id' => $item->id]) }}"><i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i>Edit</a>
                                            <a class="btn btn-link text-danger text-gradient px-3 mb-0" href="#" data-bs-toggle="modal" data-bs-target="#modal-delete-flow{{ $item->id }}"><i class="far fa-trash-alt me-2"></i>Delete</a>
                                        </td>

                                        <!-- Delete Modal -->
                                        <div class="modal fade" id="modal-delete-flow{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="modal-delete-flow{{ $item->id }}" aria-hidden="true">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-body">
                                                        <div class="py-3 text-center">
                                                            ...
                                                            <p>Apakah anda yakin ingin menghapus Alur Proses?</p>
                                                        </div>
