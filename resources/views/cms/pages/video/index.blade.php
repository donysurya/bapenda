    ...
    <div class="card-header pt-3">
        <div class="row mb-0 align-items-center">
            <div class="col-6 d-flex align-items-center">
                <h6 class="mb-0 font-weight-bolder"><i class="fa fa-youtube me-2"></i>Video</h6>
            </div>
            <div class="col-6 text-end">
                <a class="btn bg-gradient-dark mb-0" href="{{ route('cms.other.video.create') }}"><i class="fas fa-plus"></i>&nbsp;&nbsp;Tambah</a>
            </div>
        </div>
    </div>
                        ...
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-uppercase text-secondary text-xs font-weight-bolder">Nama Video</th>
                                    <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder">Video</th>
                            ...
                            <tbody>
                                @forelse($video as $index => $item)
                                    <tr>
                                            ...
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <div class="avatar avatar-sm me-3 mt-1 bg-gradient-success shadow-success text-center rounded-circle">
                                                        <i class="fa fa-youtube text-lg opacity-10" aria-hidden="true"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <td class="align-middle text-center">
                                            <a class="btn btn-link text-dark px-2 mb-0" href="{{ route('cms.other.video.edit', ['id' => $item->id]) }}"><i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i>Edit</a>
                                            <a class="btn btn-link text-danger text-gradient px-3 mb-0" href="#" data-bs-toggle="modal" data-bs-target="#modal-delete-video{{ $item->id }}"><i class="far fa-trash-alt me-2"></i>Delete</a>
                                        </td>

                                        <!-- Delete Modal -->
                                        <div class="modal fade" id="modal-delete-video{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="modal-delete-video{{ $item->id }}" aria-hidden="true">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-body">
                                                        <div class="py-3 text-center">
                                                            ...
                                                            <p>Apakah anda yakin ingin menghapus Video?</p>
                                                        </div>
