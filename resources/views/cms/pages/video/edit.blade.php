...
@section('title', 'Video | Edit Video | Administrator')
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-6 d-flex align-items-center">
                                <h6 class="mb-0 font-weight-bolder">Edit Data Video</h6>
                            </div>
                            ...
                            <div class="card px-0">
                                <div class="card-header pb-0 px-3">
                                    <div class="d-flex align-items-center">
                                        <p class="mb-0"><i class="fa fa-edit me-2"></i>Edit Video</p>
                                    </div>
                                </div>
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input class="form-control @error('name') is-invalid @enderror" value="{{ $video->name }}" name="name" type="text" placeholder="Nama Video">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group d-flex align-items-center">
                                                    <label for="linkYoutube" class="form-control-label me-2">Youtube video embed : </label>
