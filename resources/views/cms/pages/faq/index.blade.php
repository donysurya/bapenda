    ...
    <div class="card-header pt-3">
        <div class="row mb-0 align-items-center">
            <div class="col-6 d-flex align-items-center">
                <h6 class="mb-0 font-weight-bolder"><i class="fa fa-question-circle me-2"></i>FAQ</h6>
            </div>
            <div class="col-6 text-end">
                <a class="btn bg-gradient-dark mb-0" href="{{ route('cms.other.faq.create') }}"><i class="fas fa-plus"></i>&nbsp;&nbsp;Tambah</a>
            </div>
        </div>
    </div>
                        ...
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-uppercase text-secondary text-xs font-weight-bolder">Judul</th>
                                    <th class="px-2 text-uppercase text-secondary text-xs font-weight-bolder">Konten</th>
                            ...
                            <tbody>
                                @forelse($faq as $index => $item)
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            <span class="text-secondary text-xs font-weight-bold">{!! Str::limit( strip_tags( $item->content ), 50 ) !!}</span>
                                        </td>
                                        <td class="align-middle text-center">
                                            <span class="text-secondary text-xs font-weight-bold">{{ $item->created_at }}</span>
                                        </td>
                                        <td class="align-middle text-center">
                                            <a class="btn btn-link text-dark px-2 mb-0" href="{{ route('cms.other.faq.edit', ['id' => $item->id]) }}"><i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i>Edit</a>
                                            <a class="btn btn-link text-danger text-gradient px-3 mb-0" href="#" data-bs-toggle="modal" data-bs-target="#modal-delete-faq{{ $item->id }}"><i class="far fa-trash-alt me-2"></i>Delete</a>
                                        </td>

                                        <!-- Delete Modal -->
                                        <div class="modal fade" id="modal-delete-faq{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="modal-delete-faq{{ $item->id }}" aria-hidden="true">
