...
@section('title', 'Pelayanan | Edit Logo Pelayanan | Administrator')
...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        ...
        <h6 class="font-weight-bolder text-white mb-0"><i class="fa fa-hands-helping me-2"></i>Edit Logo</h6>
    </nav>
@endsection
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-6 d-flex align-items-center">
                                <h6 class="mb-0 font-weight-bolder">Edit Logo Pelayanan</h6>
                            </div>
                            ...
                            <div class="card px-0">
                                <div class="card-header pb-0 px-3">
                                    <div class="d-flex align-items-center">
                                        <p class="mb-0"><i class="fa fa-edit me-2"></i>Edit Logo Pelayanan</p>
                                    </div>
                                </div>
                                <div class="card-body pt-3 px-3 pb-2">
                                    ...
                                    @endif
                                    <form action="{{ route('cms.other.service.update.image', ['id' => $service->id]) }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <div class="row align-items-center">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input class="form-control @error('file') is-invalid @enderror" type="file" name="file" value="{{ $service->image }}" placeholder="Upload File">
