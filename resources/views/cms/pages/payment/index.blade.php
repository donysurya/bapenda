    ...
    <div class="card-header pt-3">
        <div class="row mb-0 align-items-center">
            <div class="col-6 d-flex align-items-center">
                <h6 class="mb-0 font-weight-bolder"><i class="fa fa-credit-card me-2"></i>Pembayaran</h6>
            </div>
            <div class="col-6 text-end">
                <a class="btn bg-gradient-dark mb-0" href="{{ route('cms.other.payment.create') }}"><i class="fas fa-plus"></i>&nbsp;&nbsp;Tambah</a>
            </div>
        </div>
    </div>
                        ...
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-uppercase text-secondary text-xs font-weight-bolder">Nama Pembayaran</th>
                                    <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder">Logo Pembayaran</th>
                                    ...
                                    <tr>
                                        ...
                                        <td style="white-space:normal!important;" class="align-middle">
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <div class="avatar avatar-sm me-3 mt-1 bg-gradient-primary shadow-primary text-center rounded-circle">
                                        ...
                                        <td class="align-middle text-center">
                                            ...
                                            <a href="{{ route('cms.other.payment.image', ['id' => $item->id]) }}" class="btn btn-success m-1 py-1 px-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Update Logo Pembayaran" style="font-size:10px;">
                                        ...
                                        <!-- Delete Modal -->
                                        <div class="modal fade" id="modal-delete-payment{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="modal-delete-payment{{ $item->id }}" aria-hidden="true">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-body">
                                                        <div class="py-3 text-center">
                                                            ...
                                                            <p>Apakah anda yakin ingin menghapus channel pembayaran?</p>
                                                        </div>
