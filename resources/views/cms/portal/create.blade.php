...
@section('title', 'Administrator Bapenda | Create Portal | Pajak Online | Kabupaten Katingan - Kalimantan Tengah')
...
@section('content')
    ...
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4"><i class="fas fa-link text-primary me-2"></i>Create Portal</h1>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item"><a href="{{ route('cms.home') }}">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="{{ route('cms.other.portal') }}">Portal</a></li>
                <li class="breadcrumb-item active">Create Portal</li>
            </ol>
                        ...
                        <div class="card-body">
                            <form action="{{ route('cms.other.portal.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <button type="submit" class="btn btn-primary"><i class="far fa-edit me-2"></i>Create Portal</button>
                                </div>
                            </form>
                        </div>
                    </div>   
