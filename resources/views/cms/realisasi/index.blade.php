...
@section('title', 'Realisasi Pendapatan Daerah | Administrator')
...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Pendapatan Daerah</li>
        </ol>
        <h6 class="font-weight-bolder text-white mb-0"><i class="fa fa-file-excel-o me-2"></i>Realisasi Pendapatan Daerah</h6>
    </nav>
@endsection
                    ...
                    <div class="card-header pt-3">
                        <div class="row mb-3">
                            ...
                            <div class="col-6 text-end">
                                <a class="btn bg-gradient-dark mb-0" href="{{ route('cms.realisasi.create') }}"><i class="fas fa-plus"></i>&nbsp;&nbsp;Tambah</a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="card px-0">
                                    ...
                                    <form method="get" action="">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <a href="{{ route('cms.realisasi') }}" class="btn btn-success btn-sm ms-auto"><i class="fa fa-th me-2"></i>Tampilkan Semua</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                            ...
                                            <tbody>
                                                @forelse($realisasi as $index => $item)
                                                    <tr>
                                                        ...
                                                        <td class="align-middle text-center">
                                                            <a class="btn btn-link text-dark px-2 mb-0" href="{{ route('cms.realisasi.edit', ['id' => $item->id]) }}"><i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i>Edit</a>
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-body">
                                                                        <div class="py-3 text-center">
                                                                            ...
                                                                            <p>Apakah anda yakin ingin menghapus data Realisasi Pendapatan Daerah?</p>
                                                                        </div>
