...
@section('content')
    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <div class="row">
                <div class="col-md-12">
                    <a href="{{route('cms.faq.create')}}" class="px-4 py-2 rounded btn btn-primary mb-4">
                                ...
                                <tbody>
                                    @forelse($faq as $index => $item)
                                        <tr>
                                            ...
                                            <td>
                                                <center>
                                                    <a href="{{ route('cms.faq.show', ['id' => $item->id]) }}" class="btn btn-primary m-1 py-1 px-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Detail" style="font-size:10px;">
                                                        <i class="fa fa-eye text-light"></i>
                                                    </a>
                                                    <a href="{{ route('cms.faq.edit', ['id' => $item->id]) }}" class="btn btn-secondary m-1 py-1 px-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Update" style="font-size:10px;">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body"> 
                                                            ...
                                                            <div class="row mb-2 text-dark d-flex justify-content-center" style="font-size:24px">
                                                                <center>Are you sure?</center>    
                                                            </div>
                                                            <div class="row text-secondary d-flex justify-content-center" style="font-size:15px">
                                                        ...
                                                        <div class="modal-footer d-flex justify-content-end">
                                                            ...
                                                            <form action="{{ route('cms.faq.destroy', ['id' => $item->id]) }}" method="post">
                                                                @csrf
                                                                @method('delete')
