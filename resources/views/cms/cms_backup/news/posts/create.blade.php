...
@section('title', 'Administrator Bapenda | Create Berita Bapenda | Pajak Online | Kabupaten Katingan - Kalimantan Tengah')
...
@section('content')
    ...
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4"><i class="bi bi-file-earmark-richtext text-primary me-2"></i>Create Berita Bapenda</h1>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item"><a href="{{ route('cms.home') }}">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="{{ route('cms.news.post.index') }}">Berita Bapenda</a></li>
                <li class="breadcrumb-item active">Create Berita Bapenda</li>
            </ol>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('cms.news.post.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" placeholder="Post Name" name="title" aria-describedby="titleDesc" value="{{ old('title') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="content" class="ckeditor form-control @error('content') is-invalid @enderror" id="content" aria-describedby="contentHelp">{{ old('content') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <button type="submit" class="btn btn-primary"><i class="far fa-edit me-2"></i>Create Berita Bapenda</button>
                                </div>
                            </form>
                        </div>
                    </div>   
