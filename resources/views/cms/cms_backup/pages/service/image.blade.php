...
@section('title', 'Administrator Bapenda | Update Logo Jenis Pelayanan | Pajak Online | Kabupaten Katingan - Kalimantan Tengah')
...
@section('content')
    ...
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4"><i class="fas fa-hands-helping text-primary me-2"></i>Update Logo Jenis Pelayanan</h1>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item"><a href="{{ route('cms.home') }}">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="{{ route('cms.other.service') }}">Jenis Pelayanan</a></li>
                <li class="breadcrumb-item active">Update Logo Jenis Pelayanan</li>
            </ol>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('cms.other.service.update.image', ['id' => $service->id]) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <button type="submit" class="btn btn-primary"><i class="far fa-edit me-2"></i>Update Logo Jenis Pelayanan</button>
                                </div>
                            </form>
                        </div>
                    </div>   
