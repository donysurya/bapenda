    ...
    <div class="card-header pt-3">
        <div class="row mb-0 align-items-center">
            <div class="col-6 d-flex align-items-center">
                <h6 class="mb-0 font-weight-bolder">Kepala Bapenda</h6>
            </div>
            <div class="col-6 text-end">
                <a class="btn bg-gradient-dark mb-0" href="{{ route('cms.profile.kepala.create') }}"><i class="fas fa-plus"></i>&nbsp;&nbsp;Tambah</a>
            </div>
        </div>
    </div>
                ...
                <div class="card-body px-0 py-3">
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    <th class="text-uppercase text-secondary text-xs font-weight-bolder">Nama Kepala</th>
                                    <th class="text-uppercase text-secondary text-xs font-weight-bolder">Foto Kepala</th>
                                ...
                                @forelse($kepala as $index => $item)
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            ...
                                            <a href="{{ route('cms.profile.kepala.image', ['id' => $item->id]) }}" class="btn btn-success m-1 py-1 px-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Update Foto" style="font-size:10px;">
                                        ...
                                        <td class="align-middle text-center">
                                            <a class="btn btn-link text-dark px-2 mb-0" href="{{ route('cms.profile.kepala.edit', ['id' => $item->id]) }}"><i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i>Edit</a>
                                            <a class="btn btn-link text-danger text-gradient px-3 mb-0" href="#" data-bs-toggle="modal" data-bs-target="#modal-delete-kepala{{ $item->id }}"><i class="far fa-trash-alt me-2"></i>Delete</a>
                                        </td>

                                        <!-- Delete Modal -->
                                        <div class="modal fade" id="modal-delete-kepala{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="modal-delete-kepala{{ $item->id }}" aria-hidden="true">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-body">
                                                        <div class="py-3 text-center">
                                                            ...
                                                            <p>Apakah anda yakin ingin menghapus Kepala Bapenda?</p>
                                                        </div>
