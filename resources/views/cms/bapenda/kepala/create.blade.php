...
@section('title', 'Administrator Bapenda | Create Kepala Bapenda | Pajak Online | Kabupaten Katingan - Kalimantan Tengah')
...
@section('content')
    ...
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4"><i class="fas fa-portrait text-primary me-2"></i>Create Kepala Bapenda</h1>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item"><a href="{{ route('cms.home') }}">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="{{ route('cms.profile.kepala') }}">Kepala Bapenda</a></li>
                <li class="breadcrumb-item active">Create Kepala Bapenda</li>
            </ol>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('cms.profile.kepala.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="jobdesk" class="ckeditor form-control @error('jobdesk') is-invalid @enderror" id="jobdesk" aria-describedby="jobdeskHelp">{{ old('jobdesk') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <button type="submit" class="btn btn-primary"><i class="far fa-edit me-2"></i>Create Kepala Bapenda</button>
                                </div>
                            </form>
                        </div>
                    </div>   
