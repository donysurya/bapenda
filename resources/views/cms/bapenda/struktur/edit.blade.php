...
@section('title', 'Struktur Organisasi Bapenda | Edit Gambar Struktur Organisasi Bapenda | Administrator')
...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        ...
        <h6 class="font-weight-bolder text-white mb-0"><i class="fas fa-question-circle me-2"></i>Struktur Organisasi</h6>
    </nav>
@endsection
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-6 d-flex align-items-center">
                                <h6 class="mb-0 font-weight-bolder">Edit Gambar Struktur Organisasi Bapenda</h6>
                            </div>
                    ...
                    <div class="card-body pt-0 pb-3">
                        <div class="row">
                            <div class="card px-0 mb-3">
                                <div class="card-header pb-0 px-3">
                                    <div class="d-flex align-items-center">
                                        <p class="mb-0"><i class="fa fa-images me-2"></i>Gambar Struktur Organisasi</p>
                                    </div>
                                </div>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <img src="{{Storage::url($struktur->image)}}" alt="{{$struktur->name}}" width="240px">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card px-0">
                                <div class="card-header pb-0 px-3">
                                    <div class="d-flex align-items-center">
                                        <p class="mb-0"><i class="fa fa-edit me-2"></i>Edit Gambar Struktur Organisasi</p>
                                    </div>
                                </div>
                                <div class="card-body pt-3 px-3 pb-2">
                                    ...
                                    <form action="{{ route('cms.profile.struktur.update', ['id' => $struktur->id]) }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    <input class="form-control @error('file') is-invalid @enderror" type="file" name="file" id="images" value="{{ $struktur->image }}" placeholder="Upload File">
