                                ...
                                @forelse($vision as $index => $item)
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            ...
                                            <a class="btn btn-link text-danger text-gradient px-3 mb-0" href="#" data-bs-toggle="modal" data-bs-target="#modal-delete-vision{{ $item->id }}"><i class="far fa-trash-alt me-2"></i>Delete</a>
                                        </td>

                                        <!-- Delete Modal -->
                                        <div class="modal fade" id="modal-delete-vision{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="modal-delete-vision{{ $item->id }}" aria-hidden="true">
