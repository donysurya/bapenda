                                    ...
                                    @forelse($flow as $index => $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('cms.other.flow.image', ['id' => $item->id]) }}" class="btn btn-info m-1 py-1 px-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Update Logo Pembayaran" style="font-size:10px;">
