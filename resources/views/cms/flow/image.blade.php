...
@section('title', 'Administrator Bapenda | Update Logo Alur Proses | Pajak Online | Kabupaten Katingan - Kalimantan Tengah')
...
@section('content')
    ...
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4"><i class="fas fa-sync text-primary me-2"></i>Update Logo Alur Proses</h1>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item"><a href="{{ route('cms.home') }}">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="{{ route('cms.other.flow') }}">Alur Proses</a></li>
                <li class="breadcrumb-item active">Update Logo Alur Proses</li>
            </ol>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('cms.other.flow.update.image', ['id' => $flow->id]) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div id="fileHelp" class="form-text">Upload logo Alur Proses (*PNG, JPG, WEBP). <strong>Maksimum Size: 50 kb</strong></div>
                                    @error('file')
                                ...
                                <div class="mb-3">
                                    ...
                                    <button type="submit" class="btn btn-primary"><i class="far fa-edit me-2"></i>Update Logo Alur Proses</button>
                                </div>
                            </form>
                        </div>
                    </div>   
