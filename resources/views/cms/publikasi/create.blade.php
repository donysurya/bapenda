...
@section('title', 'Administrator Bapenda | Create Publikasi | Pajak Online | Kabupaten Katingan - Kalimantan Tengah')
...
@section('content')
    ...
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4"><i class="fas fa-file-pdf text-primary me-2"></i>Create Publikasi</h1>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item"><a href="{{ route('cms.home') }}">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="{{ route('cms.publikasi') }}">Publikasi</a></li>
                <li class="breadcrumb-item active">Create Publikasi</li>
            </ol>
                        ...
                        <div class="card-body">
                            <form action="{{ route('cms.publikasi.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div id="fileHelp" class="form-text">Upload file (*doc,docx,xls,xlsx,pdf,jpg,jpeg,png,bmp). <strong>Maksimum Size: 5 Mb</strong>.</div>
                                    @error('file')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="mb-3">
                                    ...
                                    <button type="submit" class="btn btn-primary"><i class="far fa-edit me-2"></i>Create Publikasi</button>
                                </div>
                            </form>
                        </div>
                    </div>   
