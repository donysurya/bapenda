...
@section('title', 'Data Pegawai | Edit Data Pegawai | Administrator')
...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        ...
        <h6 class="font-weight-bolder text-white mb-0"><i class="fa fa-user me-2"></i>Edit Data Pegawai</h6>
    </nav>
@endsection
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-6 d-flex align-items-center">
                                <h6 class="mb-0 font-weight-bolder">Edit Data Pegawai</h6>
                            </div>
                            ...
                            <div class="card px-0">
                                <div class="card-header pb-0 px-3">
                                    <div class="d-flex align-items-center">
                                        <p class="mb-0"><i class="fa fa-edit me-2"></i>Edit Data Pegawai</p>
                                    </div>
                                </div>
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input class="form-control @error('nama') is-invalid @enderror" value="{{ $pegawai->nama }}" name="nama" type="text" placeholder="Nama Pegawai">
                                                    <label for="nama" class="form-control-label mt-1">Update Nama lengkap Pegawai Bapenda Katingan beserta gelar. <br>Contoh: Dr. ABC, S.T., M.Si</label>
                                                    @error('nama')
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input class="form-control @error('nip') is-invalid @enderror" value="{{ $pegawai->nip }}" name="nip" type="number" placeholder="NIP Pegawai">
                                                    <label for="nip" class="form-control-label mt-1">Update NIP lengkap Pegawai. <br><span class="text-danger"><i class="fa fa-info-circle me-2"></i>NIP yang diinputkan berupa angka 18 digit.</span></label>
                                                    @error('nip')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input class="form-control @error('jabatan') is-invalid @enderror" value="{{ $pegawai->jabatan }}" name="jabatan" type="text" placeholder="Jabatan Pegawai">
                                                    <label for="jabatan" class="form-control-label">Update Jabatan lengkap Pegawai</label>
                                                    @error('jabatan')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
