...
@section('title', 'Data Pegawai | Edit Foto Pegawai | Administrator')
...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        ...
        <h6 class="font-weight-bolder text-white mb-0"><i class="fa fa-user me-2"></i>Edit Foto Pegawai</h6>
    </nav>
@endsection
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-6 d-flex align-items-center">
                                <h6 class="mb-0 font-weight-bolder">Edit Foto Pegawai</h6>
                            </div>
                            ...
                            <div class="card px-0">
                                <div class="card-header pb-0 px-3">
                                    <div class="d-flex align-items-center">
                                        <p class="mb-0"><i class="fa fa-edit me-2"></i>Edit Foto Pegawai</p>
                                    </div>
                                </div>
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input class="form-control @error('file') is-invalid @enderror" type="file" name="file" value="{{ $pegawai->file }}" placeholder="Upload File">
